...
async def alive(client: Client, message: Message):
    ...
    await message.reply_photo(
        photo=f"https://telegra.ph/file/e2ff8823f4815b265816d.jpg",
        caption=f"""**➮𝐳 ʜɪɪ ɪ ᴍ [{BOT_NAME}](https://t.me/{BOT_USERNAME})**

➮ **MY Sყʂƚҽɱ Wσɾƙιɳɠ Fιɳҽ**

➮ **my version : 5.0 Lҽƚҽʂƚ**
            ...
            [
                [
                    InlineKeyboardButton(
                        "💫 ɢʀᴏᴜᴘ", url=f"https://t.me/ELECTROBOT_SUPPORT"
                    ),
                    InlineKeyboardButton(
                        "ᴄʜᴀɴɴᴇʟ ☑️", url=f"https://t.me/ELECTROBOT_SUPPORT"
                    )
                ]
            ]
        )
